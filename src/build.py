  ...
  <div class="wrap">
    <div class="split">
      <div class="sticky">
        ...
        <h2 class="h-l rv d1">회사 전체를<br>수시간 안에 AX합니다</h2>
        <p class="lead rv d2" style="margin-top:20px">코딩을 모르는 구성원 전원이 자기 말로 회사의 프로그램을 짓고 고치게 됩니다. 우리는 이 방식으로 운용업을 먼저 바꿨습니다.</p>
